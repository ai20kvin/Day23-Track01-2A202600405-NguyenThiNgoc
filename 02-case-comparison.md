...
| **Rủi ro lớn nhất** | FA over-reliance: tin vào AI mà bỏ bước kiểm chứng, đặc biệt nguy hiểm với thông tin tài chính nhạy cảm | "Gaming the system": nhân viên dùng **mouse jiggler** để giả vờ đang làm việc; tập trung vào "trông có vẻ productive" thay vì làm việc thực sự *(nguồn: [eFinancialCareers](Report: [Palantir Helped JPMorgan Spy on Employee](https://slate.com/technology/2018/04/jpmorgan-used-palantir-tools-monitor-employee-activity-bloomberg-report.html)))* |
...
| JPMorgan WADU | eFinancialCareers — Mouse Jiggler, Paranoia | https://www.efinancialcareers.com/news/2022/05/jpmorgan-spying-on-employees ](https://icon.ink/articles/jpmorgan-palantir-exposed-surveillance-bloomberg/|
